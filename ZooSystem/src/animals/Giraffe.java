...
/**
 *  A class that represents an Giraffe, it extends ChewAnimal 
 *  has 1 attribute: neckLength - a int for a neck length.
 * 
 * @version 1.0
 */
public class Giraffe extends ChewAnimal {
	...
	/**
	 *  A Ctor, uses the super Ctor(Animals), sets a default weight, Herbivore diet and a neck length = 1.5 .
	 * 
	 * @version 1.0
	 * 
	...
	/**
	 *  Another Ctor, Gets a name and neck lengh. sets the point to the Elephants default and the neck lengh to the parameter
	 * 
	 * @version 1.0
	 * 
