...
/**
 *   A class that implements IDiet interface, this class is a type of a diet that eats vegetable
 * 
 * @version 1.0
 */
 ...
 *  checks if the food the animal got is vegetable.
 *
 * 
 * @version 1.0
 * 
...
/**
 * A method that overides the interface's and returns the weight the animal will gain if he can eat the food (0.07 of it's weight) 
